# Parque-DiBiase 🚗💡
> **Projeto Acadêmico de Estacionamento Inteligente**

O **Parque-DiBiase** é um sistema de gerenciamento de estacionamento inteligente desenvolvido como projeto acadêmico. O objetivo principal é otimizar o fluxo de veículos, automatizar o controle de vagas e oferecer uma interface intuitiva para a gestão do pátio.
